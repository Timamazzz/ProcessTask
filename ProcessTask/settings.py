"""
Django settings for ProcessTask project.
...
SECRET_KEY = 'django-insecure-u*dj5xyj4#dk=4y!gw@@hou#zf=la6!5($ucgn$fzw&j8@@^-('
...
WSGI_APPLICATION = 'ProcessTask.wsgi.application'
...
FRONTEND_BUILD_DIR = BASE_DIR.parent / 'reestr'
STATICFILES_DIRS = [
